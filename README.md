...
|-----------------------|-------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| **API Gateway**       | Any source → 8080                                     | User Service → 8700, Product Service → 8500, Order Service → 8300, Payment Service → 8400, Shipping Service → 8600, Favourite Service → 8800, DNS → 53,Proxy Client → 8900, Cloud Config → 9296, Jaeger → 9411, Eureka → 8761 |
